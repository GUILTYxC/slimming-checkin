...
export default function DailyEntry() {
  ...
  const currentRecord = selectedDate ? recordsMap[selectedDate] : null
  const hasCurrentData = currentRecord && (
    currentRecord.weight != null ||
    currentRecord.caloriesBurned != null ||
    (currentRecord.activities && Object.values(currentRecord.activities).some((v) => v))
  )

  return (
    <div className="h-full flex flex-col">
      <h2 className="text-xl font-bold text-zinc-800 tracking-tight mb-4 flex-shrink-0">每日打卡</h2>
